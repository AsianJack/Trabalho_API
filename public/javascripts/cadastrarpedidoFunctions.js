...
function obterIdDaURL() {
    ...
    const partesDoCaminho = path.split('/'); // Divide o caminho em partes usando a barra como separador
    const id = partesDoCaminho[partesDoCaminho.length - 1]; // Obtém o último elemento do array, que é o ID
    return id;
}