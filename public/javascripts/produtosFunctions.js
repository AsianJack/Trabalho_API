...
//serve apenas para chamar a tela editar
function editarProduto(id) {
    window.location.href = `/produtos/editarProd/${id}`;
}

//toda vez que a pagina carregar ele vai pegar todos os produtos e colocar na lista
...
//serve para fazer a parte de pesquisa
